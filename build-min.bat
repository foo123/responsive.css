...
rem python %BUILDTOOLS%\Beeld.py --config ".\beeld.config" --compiler cssmin --tasks minify

rem to use the php build tool do (the dependencies file is passed as argument):
rem php -f %BUILDTOOLS%\Beeld.php -- --config=".\beeld.config" --compiler=cssmin --tasks=minify

rem to use the node build tool do (the dependencies file is passed as argument):
node %BUILDTOOLS%\Beeld.js --config ".\beeld.config" --compiler cssmin --tasks minify
